...
export default function Page() {
    return (
        <div className="w-screen h-screen border border-yellow-400 rounded-xl flex flex-row justify-end mt-10 bg-gradient-to-r to-amber-700 from-yellow-500 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.3)] p-10">
